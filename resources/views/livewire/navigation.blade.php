          ...
          <div class="hidden sm:block sm:ml-6" >
           ...
           <div x-show="open" @click.away="open = false" class="o-left origin-top-right absolute right-0 mt-2 w-56 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
             <div class="py-1" role="none">
                ...
                <a href="{{route('notifications.index')}}" class="text-gray-300 hover:bg-cyan-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1">Lista de novedades</a>
              </div>
          </div>
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="open" @click.away="open = false">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <div class="relative block text-left none" x-data="{ open: false }">
          ...
          <div x-show="open" @click.away="open = false" class="origin-top-right absolute right-0 mt-2 w-full rounded-md shadow-lg bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
            <div class="py-1" role="none">
              <a href="{{route('notifications.create')}}" class="text-gray-300 hover:bg-gray-700 block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0"> Crear novedad </a>
