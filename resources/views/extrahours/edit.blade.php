<x-app-layout>
    ...
    <div class="flex flex-wrap  mb-6 mx-auto">
      ...
      <div class="grid grid-cols-2 mb-6 mx-auto">
          <div class="px-3">
            ...
            {!! Form::date("started_date",  (isset($extraHour)) ? $extraHour->started_date : null ,['class'=>'form-control']) !!}
        ...
        <div class="px-3">
           ...
           {!! Form::time("started_time", (isset($extraHour)) ? $extraHour->started_time : null  ,['class'=>'form-control']) !!}
        </div>
    ...
    <div class="grid grid-cols-2 mb-6 mx-auto">
      <div class="px-3">
        ...
        {!! Form::date("finish_date", (isset($extraHour)) ? $extraHour->finish_date : null ,['class'=>'form-control']) !!}
      @error('finish_date')
      <small class="text-red-600 font-bold text-base">
         *{{$message}}
        </small>
     ...
     <div class="px-3">
       ...
       {!! Form::time("finish_time", (isset($extraHour)) ? $extraHour->finish_time : null,['class'=>'form-control']) !!}
      </div>
    ...
    <div class="flex flex-wrap  mb-6 mx-auto">
        <div class="w-full px-3">
            ...
            <div class="text-center">
                {!! Form::checkbox('support',null ,$extraHour->support,['class'=>'form-check-input inline-block appearance-none w-24 rounded-full  h-8 align-top bg-white bg-no-repeat bg-contain bg-gray-300 focus:outline-none cursor-pointer shadow-sm'] ) !!}
            </div>
